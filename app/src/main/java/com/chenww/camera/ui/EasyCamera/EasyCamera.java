package com.chenww.camera.ui.EasyCamera;
 ...
 * </pre>
 * 
 * Remember to invoke camera.close() when you are done using the camera - this
 * can be done in the callback, or in an inPause(..) method of an Activity
 */
public interface EasyCamera { // TODO implements AutoCloseable {
	/**
	 * See <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#release%28%29"
	 * >Camera.release()</a>
	 */
	void close();
	...
	/**
	 * See <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#unlock%28%29"
	 * >Camera.unlock()</a>
	 */
	void unlock();
	...
	/**
	 * See <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#lock%28%29"
	 * >Camera.lock()</a>
	 */
	void lock();
	...
	/**
	 * See <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#reconnect%28%29"
	 * >Camera.reconnect()</a>
	 */
	void reconnect() throws IOException;

	/**
	 * Convenient method that combines two steps required before taking
	 * pictures: <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#setPreviewDisplay%28android.view.SurfaceHolder%29"
	 * >Setting surface</a> <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#startPreview%28%29"
	 * >Starting preview</a>
	 */
	 ...
	 * Convenient method that combines two steps required before taking
	 * pictures: <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#setPreviewTexture%28android.graphics.SurfaceTexture%29"
	 * >Setting texture</a> <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#startPreview%28%29"
	 * >Starting preview</a>
	 */
	...
	/**
	 * See <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#stopPreview%28%29"
	 * >Camera.stopPreview()</a>
	 */
	void stopPreview();
	...
	/**
	 * See <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#setOneShotPreviewCallback%28android.hardware.Camera.PreviewCallback%29"
	 * >Camera.setOneShotPreviewCallback(..)</a>
	 */
	void setOneShotPreviewCallback(Camera.PreviewCallback cb);

	/**
	 * See <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#setPreviewCallbackWithBuffer%28android.hardware.Camera.PreviewCallback%29"
	 * >Camera.setPreviewCallbackWithBuffer(..)</a>
	 */
	...
	/**
	 * See <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#cancelAutoFocus%28%29"
	 * >Camera.cancelAutoFocus()</a>
	 */
	void cancelAutoFocus();

	/**
	 * See <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#startSmoothZoom%28int%29"
	 * >Camera.startSmoothZoom(..)</a>
	 */
	void startSmoothZoom(int value);

	/**
	 * See <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#stopSmoothZoom%28%29"
	 * >Camera.stopSmoothZoom()</a>
	 */
	void stopSmoothZoom();
	...
	/**
	 * See <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#setZoomChangeListener%28android.hardware.Camera.OnZoomChangeListener%29"
	 * >Camera.setZoomChangeListener(..)</a>
	 */
	void setZoomChangeListener(Camera.OnZoomChangeListener listener);

	/**
	 * See <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#setErrorCallback%28android.hardware.Camera.ErrorCallback%29"
	 * >Camera.setErrorCallback(..)</a>
	 */
	void setErrorCallback(Camera.ErrorCallback cb);

	/**
	 * See <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#setParameters%28android.hardware.Camera.Parameters%29"
	...
	/**
	 * See <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#getParameters%28%29"
	 * >Camera.getParameters(..)</a>
	 */
	Camera.Parameters getParameters();

	/**
	 * See <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#enableShutterSound%28boolean%29"
	 * >Camera.enableShutterSound(..)</a>
	 */
	boolean enableShutterSound(boolean enabled);

	/**
	 * See <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#setAutoFocusMoveCallback%28android.hardware.Camera.AutoFocusMoveCallback%29"
	 * >Camera.setAutoFocusMoveCallback(..)</a>
	 */
	void setAutoFocusMoveCallback(Camera.AutoFocusMoveCallback cb);

	/**
	 * See <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#setFaceDetectionListener%28android.hardware.Camera.FaceDetectionListener%29"
	 * >Camera.setFaceDetectionListener(..)</a>
	 */
	 ...
	 * >Camera.startFaceDetection()</a>
	 */
	void startFaceDetection();

	/**
	 * See <a href=
	 * "http://developer.android.com/reference/android/hardware/Camera.html#stopFaceDetection%28%29"
	 * >Camera.stopFaceDetection()</a>
	 */
	...
	public final class Callbacks {
		...
		private Callbacks() {
			// private constructor to disable instantiation apart from the
			// factory method
		}
